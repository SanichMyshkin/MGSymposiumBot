...
1. Секреты в докере!
2. Решить что делать с файлами
3. упаковать самого бота в докер
4. Плейбук сделать который на сервере все это развернет!

# ВАЖНЫЕ
1. Разобраться с добавлением событий 
2. добавить ко всему этому фотогорафии
3. вынести админку
4. 
